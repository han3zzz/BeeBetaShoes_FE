...
window.MuiGiayController = function($scope, $http, $location,$routeParams){
    let url = "http://localhost:8080/api/toe";
    ...
    $scope.add = function(){
      ...
      $scope.update = function(){
        ...
        $http.put("http://localhost:8080/api/toe/update/"+id,{
            name : $scope.form.name,
            description : $scope.form.description
        }).then(function(resp){
            if(resp.status === 200){
      ...
      $scope.delete = function (id){
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $http.put("http://localhost:8080/api/toe/delete/"+id).then(function (response){
    ...
    $scope.detail = function(){
        let id = $routeParams.id ;
        $http.get("http://localhost:8080/api/toe/" + id).then(function(resp){
    ...
    $scope.search = function (){
        ...
        if (name.trim().length === 0){
            ...
            $http.get("http://localhost:8080/api/toe/search/"+name).then(function (search){
