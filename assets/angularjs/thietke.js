...
window.ThietKeController = function($scope, $http, $location,$routeParams){
    let url = "http://localhost:8080/api/design";
    ...
    $scope.add = function(){
      ...
      $scope.update = function(){
        ...
        $http.put("http://localhost:8080/api/design/update/"+id,{
            name : $scope.form.name,
            description : $scope.form.description
        }).then(function(resp){
            if(resp.status === 200){
    ...
    $scope.detail = function(){
        let id = $routeParams.id ;
        $http.get("http://localhost:8080/api/design/" + id).then(function(resp){
    ...
    $scope.search = function (){
        ...
        if (name.trim().length === 0){
            ...
            $http.get("http://localhost:8080/api/design/search/"+name).then(function (search){
